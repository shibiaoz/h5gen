...
<html>
  <head>
    ...
    <?= HTML::css('dep/h5legen_interface/h5legen_loading.css', 'splatform')?>
  </head>
  <body>
    <?php echo('<img src="' . $iconUrl . '" class="lg-icon">')?>
    <div id="loading">
      <div id="shushuo" class='uil-ring-css' style='-webkit-transform:scale(0.5)'><div></div></div>
      <p class="progress"></p>
    </div>
...
?>
<?= HTML::css('dep/h5legen_interface/h5legen_interface.css', 'splatform')?>
...
?>
<?= HTML::js('dep/h5legen_interface/h5legen_interface.js', 'splatform')?>
<script>
/**
 * 这里写代码，一定要严格，该分号的分号，
 * 注释不要用//
